...
import 'manteinance_model.dart';
export 'manteinance_model.dart';

class ManteinanceWidget extends StatefulWidget {
  const ManteinanceWidget({super.key});

  static String routeName = 'Manteinance';
  static String routePath = '/planes-de-mantenimiento';

  @override
  State<ManteinanceWidget> createState() => _ManteinanceWidgetState();
}

class _ManteinanceWidgetState extends State<ManteinanceWidget> {
  late ManteinanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManteinanceModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Manteinance'});
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MANTEINANCE_Container_1gx8h03a_ON_TAP');
                                    await launchURL(
