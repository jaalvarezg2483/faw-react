...
class WorkshopsWidget extends StatefulWidget {
  ...
  static String routePath = '/talleres';

  @override
  State<WorkshopsWidget> createState() => _WorkshopsWidgetState();
}
...
class _WorkshopsWidgetState extends State<WorkshopsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Workshops'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UbicacionesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UbicacionesRecord> workshopsUbicacionesRecordList = snapshot.data!;
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final talleres =
                                              workshopsUbicacionesRecordList
                                                  .where((e) => e.isRepairShop)
                                                  .toList();
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                                (context, talleresIndex) {
                                              final talleresItem =
                                                  talleres[talleresIndex];
                                              return Container(
                                                decoration: BoxDecoration(
                                                  border: Border.all(
                                                ...
                                                child: LocationCardWidget(
                                                  key: Key(
                                                      'Keyhez_${talleresIndex}_of_${talleres.length}'),
                                                  typeLocation: 'Taller',
                                                  location: talleresItem,
                                                ),
                                              );
                                            },
                                          );
                                                  ...
                                                  children: [
                                                            ...
                                                            onChanged:
                                                              ...
                                                              safeSetState(() =>
                                                                  _model.ddTypeValue =
                                                                      val);
                                                              logFirebaseEvent(
                                                                  'WORKSHOPS_ddType_ON_FORM_WIDGET_SELECTED');
                                                        ...
                                                        Theme(
                                                          ...
                                                          child: Checkbox(
                                                            ...
                                                            onChanged:
                                                              ...
                                                              if (newValue!) {
                                                                logFirebaseEvent(
                                                                    'WORKSHOPS_TermsCheckbox_ON_TOGGLE_ON');
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Theme(
                                                          ...
                                                          child: Checkbox(
                                                            ...
                                                            onChanged:
                                                              ...
                                                              if (newValue!) {
                                                                logFirebaseEvent(
                                                                    'WORKSHOPS_Checkbox_et7ej2ta_ON_TOGGLE_ON');
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            'Autorizo a Grupo Purdy el envío de información de sus productos \ny la utilización de mis datos de contacto',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelLarge
                                                                .override(
