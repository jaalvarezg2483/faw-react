...
import 'financev1_model.dart';
export 'financev1_model.dart';

class Financev1Widget extends StatefulWidget {
  const Financev1Widget({super.key});

  static String routeName = 'Financev1';
  static String routePath = '/financiamiento-old';

  @override
  State<Financev1Widget> createState() => _Financev1WidgetState();
}

class _Financev1WidgetState extends State<Financev1Widget> {
  late Financev1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Financev1Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Financev1'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('FINANCEV1_PAGE_Financev1_ON_INIT_STATE');
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'FINANCEV1_IR_A_P_U_R_D_Y_G_O_Y_RESERVAR_');
                                      await launchURL(
                                          ...
                                          children: [
                                            ...
                                            TextSpan(
                                              ...
                                              recognizer: TapGestureRecognizer()
                                                ..onTap = () async {
                                                  logFirebaseEvent(
                                                      'FINANCEV1_RichTextSpan_cwbk9nis_ON_TAP');
                                                  await launchURL(
