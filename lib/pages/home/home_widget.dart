                                ...
                                children: [
                                  Flexible(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOME_PAGE_RichText_gqtjotqe_ON_TAP');
                                          ...
                                          children: [
                                            Expanded(
                                              child:
                                                ...
                                                onChanged: (val) async {
                                                  safeSetState(() =>
                                                      _model.ddTypeValue = val);
                                                  logFirebaseEvent(
                                                      'HOME_PAGE_ddType_ON_FORM_WIDGET_SELECTED');
                                            ...
                                            Theme(
                                              ...
                                              child: Checkbox(
                                                ...
                                                onChanged: (newValue) async {
                                                  ...
                                                  if (newValue!) {
                                                    logFirebaseEvent(
                                                        'HOME_PAGE_Checkbox_268wgljn_ON_TOGGLE_ON');
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_PAGE_Text_68wcztry_ON_TAP');
                                                await launchURL(
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_PAGE_Text_yf5eaxpb_ON_TAP');
                                                await launchUrl(Uri(
                                                  scheme: 'tel',
                                                  path: '+50625197777',
                                                ));
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_PAGE_Text_ezveeevh_ON_TAP');
                                                await launchURL(
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_PAGE_Text_mivsxwzr_ON_TAP');
                                                  await launchURL(
