                          ...
                          children: [
                            if (responsiveVisibility(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'HOME_COPY_IR_A_P_U_R_D_Y_G_O_Y_RESERVAR_');
                                  await launchURL(
                                        ...
                                        children: List.generate(
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_COPY_PAGE_Container_ljm88eu5_ON_TAP');
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return Wrap(
                                              ...
                                              clipBehavior: Clip.none,
                                              children: List.generate(
                                                  models.length, (modelsIndex) {
                                                final modelsItem =
                                                    models[modelsIndex];
                                                return SelectedModelWidget(
                                                  key: Key(
                                                      'Keyxw9_${modelsIndex}_of_${models.length}'),
                                                  model: modelsItem,
                                                );
                                              }),
                                            );
                                    ...
                                    Form(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                                ...
                                                child:
                                                  ...
                                                  onChanged: (val) async {
                                                    safeSetState(() => _model
                                                        .ddTypeValue = val);
                                                    logFirebaseEvent(
                                                        'HOME_COPY_ddType_ON_FORM_WIDGET_SELECTED');
                                          ...
                                          if (_model.isIdNotSelected == true)
                                            Row(
                                              mainAxisSize: MainAxisSize.max,
                                              mainAxisAlignment:
                                              ...
                                              Theme(
                                                ...
                                                child: Checkbox(
                                                  ...
                                                  onChanged: (newValue) async {
                                                    ...
                                                    if (newValue!) {
                                                      logFirebaseEvent(
                                                          'HOME_COPY_Checkbox_d06mn8mu_ON_TOGGLE_ON');
                                          ...
                                          if (_model.isTermsNotSelect == true)
                                            Align(
                                              ...
                                              children: [
                                                FFButtonWidget(
                                                  onPressed: !(FFAppState()
                                                      ...
                                                      : () async {
                                                          logFirebaseEvent(
                                                              'HOME_COPY_PAGE_ENVIAR_BTN_ON_TAP');
                                                          var _shouldSetState =
                                                              false;
                                                          await Future.wait([
                                                            Future(() async {
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_COPY_PAGE_Text_ckx7hu56_ON_TAP');
                                                  await launchURL(
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_COPY_PAGE_Text_3aj1w4ri_ON_TAP');
                                                  await launchUrl(Uri(
                                                    scheme: 'tel',
                                                    path: '+50625197777',
                                                  ));
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_COPY_PAGE_Text_fbsp5cq3_ON_TAP');
                                                  await launchURL(
                                            ...
                                            children: [
                                              ...
                                              Flexible(
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'HOME_COPY_PAGE_Text_sxtn8gad_ON_TAP');
                                                    await launchURL(
                                          ...
                                          child: Container(
                                            child: wrapWithModel(
                                              ...
                                              child:
                                                ...
                                                buttonAction: () async {
                                                  logFirebaseEvent(
                                                      'HOME_COPY_Container_8vw3vdnx_CALLBACK');
                                      ...
                                      child: Container(
                                        child: wrapWithModel(
                                          ...
                                          child: SectionTitleWithButtonWidget(
                                            ...
                                            buttonAction: () async {
                                              logFirebaseEvent(
                                                  'HOME_COPY_Container_qrd4luxl_CALLBACK');
