...
class _ModelWidgetState extends State<ModelWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModelModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Model'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ModelsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ModelsRecord> modelModelsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final modelModelsRecord = modelModelsRecordList.isNotEmpty
            ? modelModelsRecordList.first
            : null;
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        functions.getImageURL(
                                            containerImagesRecordList.toList(),
                                            'Banner')!,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MODEL_PAGE_Container_nreq78fg_ON_TAP');
                                                await launchURL(
                                                    'https://wa.me://50685891000?text=%C2%A1Quiero%20RESERVAR%20el%20FAW%20${modelModelsRecord?.name}%21');
                                              },
                                              child: Container(
                                                constraints: BoxConstraints(
                                                  maxWidth: 325.0,
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MODEL_PAGE_Container_6z32ns8p_ON_TAP');
                                                await launchURL(
                                                    'https://wa.me://50685891000?text=%C2%A1Quiero%20solicitar%20Test%20Drive%20para%20el%20FAW%20${modelModelsRecord?.name}%21');
                                              },
                                              child: Container(
                                                constraints: BoxConstraints(
                                                  maxWidth: 325.0,
                                ...
                                StreamBuilder<List<CaracteristicasRecord>>(
                                                        ...
                                                        children: List.generate(
                                                          ...
                                                          return wrapWithModel(
                                                            ...
                                                            child:
                                                                FeatureCardWidget(
                                                              key: Key(
                                                                'Key8ps_${featureListIndex.toString()}',
                                                              ),
                                                              features:
                                                                  featureListItem,
                                                            ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: StreamBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<CaracteristicasRecord>
                                                          columnOldFeaturesCaracteristicasRecordList =
                                                          snapshot.data!;
                                                      ...
                                                      return Column(
                                                        ...
                                                        children: List.generate(
                                                            columnOldFeaturesCaracteristicasRecordList
                                                                .length,
                                                            (columnOldFeaturesIndex) {
                                                          final columnOldFeaturesCaracteristicasRecord =
                                                              columnOldFeaturesCaracteristicasRecordList[
                                                                  columnOldFeaturesIndex];
                                                          return Container(
                                                            width: MediaQuery
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Image.network(
                                                                  columnOldFeaturesCaracteristicasRecord
                                                                      .url,
