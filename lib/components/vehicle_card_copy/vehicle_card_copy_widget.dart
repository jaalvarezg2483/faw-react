...
import 'vehicle_card_copy_model.dart';
export 'vehicle_card_copy_model.dart';

class VehicleCardCopyWidget extends StatefulWidget {
  const VehicleCardCopyWidget({
    super.key,
    required this.name,
  ...
  @override
  State<VehicleCardCopyWidget> createState() => _VehicleCardCopyWidgetState();
}

class _VehicleCardCopyWidgetState extends State<VehicleCardCopyWidget> {
  late VehicleCardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VehicleCardCopyModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'VEHICLE_CARD_COPY_COTIZARLO_BTN_ON_TAP');
