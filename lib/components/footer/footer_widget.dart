                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent('FOOTER_COMP_TextCamiones_ON_TAP');
                            await launchURL(
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            await launchURL('https://www.grupopurdy.com/');
                          },
                          child: Text(
                            'Grupo Purdy',
                            style: FlutterFlowTheme.of(context)
                  ...
                  Container(
                    ...
                    child: StreamBuilder<List<FooterRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<FooterRecord> rowFooterRecordList = snapshot.data!;

                        return Row(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: List.generate(rowFooterRecordList.length,
                              (rowIndex) {
